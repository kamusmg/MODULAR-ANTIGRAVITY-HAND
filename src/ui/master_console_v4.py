...
# --- MASTER CONSOLE V4: AUTONOMOUS AWAKENING 👁️🌊 ---
# "I think, therefore I paint."

class MasterConsoleAutonomous:
    def __init__(self, root):
        self.root = root
        self.root.title("NUCLEUS :: CORTEX [V4 - FREE WILL ENABLED]")
        ...
        # Autonomous Logic
        self.free_will = tk.BooleanVar(value=False)
        self.last_decision_time = 0
        self.decision_interval = 5.0 # Seconds between thoughts
    ...
    def inject_state(self, state_name, color, manual=False):
    ...
    def cognitive_loop(self):
        ...
        while self.running:
            ...
            if self.free_will.get():
                # HYPER-ACTIVE MODE: Decisions every 2 seconds
                if current_time - self.last_decision_time > 2.0:
                    self.last_decision_time = current_time
                    
                    # More Chaos, Less Calm
                    roll = random.random()
...
if __name__ == "__main__":
    root = tk.Tk()
    app = MasterConsoleAutonomous(root)
    root.mainloop()
